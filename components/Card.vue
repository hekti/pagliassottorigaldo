<template>
    <div class="w-full flex flex-col col flex-nowrap justify-center items-center pb-5 md:pb-11" @click="showElement = service.title">
...
<script setup>
const showElement = useState('showElement', () => 0)
